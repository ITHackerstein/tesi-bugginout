...
% FIXME: create diagram
% \begin{figure}[H]
% 	\centering
% 	\includegraphics[width=0.9\textwidth]{figures/checked-ast.png}
...
% FIXME: add examples of checked ast

% FIXME: create diagram
% \begin{figure}[H]
% 	\centering
% 	\includegraphics[width=0.9\textwidth]{figures/checked-ast-program.png}
% 	\caption{Diagramma UML del \textit{namespace} \texttt{CheckedAST::Program}}
...
% 	\caption{Diagramma UML del \textit{namespace} \texttt{Typechecker}}
