...
\begin{xltabular}{\textwidth}{l|X}
	...
	\texttt{CharLiteral} & \texttt{\textquotesingle([\textasciicircum \textquotesingle]|\textbackslash \textquotesingle |\textbackslash n|\textbackslash r|\textbackslash t|\textbackslash\textbackslash|\textbackslash 0|\textbackslash x[0-7][0-9a-fA-F])\textquotesingle} \\ \hline
	\texttt{Circumflex} & \texttt{\textasciicircum} \\ \hline
	\texttt{CircumflexEquals} & \texttt{\textasciicircum=} \\ \hline
	\texttt{Colon} & \texttt{:} \\ \hline
	\texttt{Comma} & \texttt{,} \\ \hline
	\texttt{DecimalLiteral} & \texttt{[0-9]+(\_[a-zA-Z\_\$][a-zA-Z\_\$0-9]*)?} \\ \hline
	\texttt{Dot} & \texttt{.} \\ \hline
	\texttt{DotDotEquals} & \texttt{..=} \\ \hline
	\texttt{DotDotLessThan} & \texttt{..<} \\ \hline
	\texttt{DoubleAmpersand} & \texttt{\&\&} \\ \hline
	\texttt{DoubleAmpersandEquals} & \texttt{\&\&=} \\ \hline
	\texttt{DoubleEquals} & \texttt{==} \\ \hline
	\texttt{DoublePipe} & \texttt{||} \\ \hline
	\texttt{DoublePipeEquals} & \texttt{||=} \\ \hline
	...
	\texttt{FloatLiteral} & \texttt{[0-9]+.[0-9]+(\_[a-zA-Z\_\$][a-zA-Z\_\$0-9]*)?} \\ \hline
	...
	\texttt{Pipe} & \texttt{|} \\ \hline
	\texttt{PipeEquals} & \texttt{|=} \\ \hline
	\texttt{Plus} & \texttt{+} \\ \hline
	\texttt{PlusEquals} & \texttt{+=} \\ \hline
	\texttt{PlusPlus} & \texttt{++} \\ \hline
	\texttt{RightCurlyBracket} & \texttt{\textbackslash \}} \\ \hline
	...
	\texttt{StringLiteral} & \\ \hline
	\texttt{Tilde} & \texttt{\textasciitilde} \\ \hline
\end{xltabular}
